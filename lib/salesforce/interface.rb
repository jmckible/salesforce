module Salesforce
  module Interface
    ...
    def salesforce_email()    '' end
    def salesforce_password() '' end
    def salesforce_api_key()  '' end  
      
    def save_salesforce_session()   true end
    def unsave_salesforce_session() true end
